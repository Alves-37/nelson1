...
railway variables set DATABASE_PUBLIC_URL="postgresql://postgres:SewgLWaPipGKIRlLZlUmJcCsogfxkziX@mainline.proxy.rlwy.net:15908/railway"

echo 2. Configurando DATABASE_URL...
railway variables set DATABASE_URL="postgresql://postgres:SewgLWaPipGKIRlLZlUmJcCsogfxkziX@postgres.railway.internal:5432/railway"
